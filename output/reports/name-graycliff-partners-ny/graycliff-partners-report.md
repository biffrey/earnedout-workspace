# Graycliff Partners — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Graycliff Partners | SBA SBIC Directory ("Managed by") |
| Location (city, state) | New York, NY | SBA SBIC Directory |
| # licensed funds under this GP | 3 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $480,098,345 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Andrew P. Trigg — atrigg@graycliffpartners.com — 212-300-2903 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Graycliff Mezzanine II LP** — vintage 2012, size $38,908,334, avg inv $2,836,622, strategy: Mezzanine, style: Hybrid, making new investments: No
- **Graycliff Mezzanine III (SBIC) LP** — vintage 2018, size $285,690,011, avg inv $4,994,406, strategy: Mezzanine, style: Private Credit, making new investments: No
- **Graycliff Mezzanine IV (SBIC) LP** — vintage 2022, size $155,500,000, avg inv $5,804,960, strategy: Mezzanine, style: Private Credit, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $480,098,345 of committed capital, a typical mgmt-fee yield is in the rough range of **$7,201,475–$12,002,458 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Graycliff Partners" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Andrew P. Trigg.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: atrigg@graycliffpartners.com.
