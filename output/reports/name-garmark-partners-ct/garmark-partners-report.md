# GarMark Partners — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | GarMark Partners | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Stamford, CT | SBA SBIC Directory |
| # licensed funds under this GP | 2 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $345,439,342 | SBA SBIC Directory |
| Earliest fund vintage | 2014 | SBA SBIC Directory |
| Latest fund vintage | 2018 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Steven Pickhardt — spickhardt@garmark.com — (203) 325-8500 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **GarMark SBIC Fund II, L.P.** — vintage 2018, size $273,450,000, avg inv $4,181,726, strategy: Hybrid Debt/Equity, style: Private Credit, making new investments: No
- **GarMark SBIC Fund, L.P.** — vintage 2014, size $71,989,342, avg inv $3,424,199, strategy: Hybrid Debt/Equity, style: Private Credit, making new investments: No
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $345,439,342 of committed capital, a typical mgmt-fee yield is in the rough range of **$5,181,590–$8,635,983 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.

### 4. Investment Strategy & Activity
Strategies on file: Hybrid Debt/Equity. Fund styles: Private Credit. Active for new investments: **No (winding down)** — a wind-down GP may indicate willingness to monetize the management entity, including the SBIC license.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "GarMark Partners" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Steven Pickhardt.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: spickhardt@garmark.com.
