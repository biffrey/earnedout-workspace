# MinCal Management, Inc. — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | MinCal Management, Inc. | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Minneapolis, MN | SBA SBIC Directory |
| # licensed funds under this GP | 2 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $200,581,328 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | John Chan — jchan@cvcap.com — 763-432-4080 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Convergent Capital Partners IV, LP** — vintage 2020, size $165,703,875, avg inv $3,628,153, strategy: Mezzanine, style: Private Credit, making new investments: Yes
- **Convergent Capital Partners V, L.P.** — vintage 2026, size $34,877,453, avg inv $0, strategy: Mezzanine, style: Private Credit, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $200,581,328 of committed capital, a typical mgmt-fee yield is in the rough range of **$3,008,719–$5,014,533 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "MinCal Management, Inc." and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: John Chan.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: jchan@cvcap.com.
