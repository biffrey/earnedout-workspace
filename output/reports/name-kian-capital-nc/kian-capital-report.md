# Kian Capital — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Kian Capital | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Charlotte, NC | SBA SBIC Directory |
| # licensed funds under this GP | 3 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $676,716,514 | SBA SBIC Directory |
...
| Investment strategies | Buyout, Mezzanine | SBA SBIC Directory |
| Fund styles | Hybrid | SBA SBIC Directory |
| Investor Relations contact (primary) | Charlie Edmondson — cedmondson@kiancapital.com — (704) 943-2501 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Kian Growth Partners III, L.P.** — vintage 2023, size $388,454,636, avg inv $4,826,742, strategy: Buyout, style: Hybrid, making new investments: Yes
- **Kian Mezzanine Partners I, L.P.** — vintage 2014, size $40,025,891, avg inv $2,872,087, strategy: Mezzanine, style: Hybrid, making new investments: No
- **Kian Mezzanine Partners II, L.P.** — vintage 2018, size $248,235,987, avg inv $3,681,373, strategy: Mezzanine, style: Hybrid, making new investments: No
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $676,716,514 of committed capital, a typical mgmt-fee yield is in the rough range of **$10,150,747–$16,917,912 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.

### 4. Investment Strategy & Activity
Strategies on file: Buyout, Mezzanine. Fund styles: Hybrid. Active for new investments: **Yes** — an active GP suggests an ongoing economic engine.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Kian Capital" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Charlie Edmondson.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: cedmondson@kiancapital.com.
