# SENECA GLOBAL SERVICES LLC — Prospect Evaluation
...
| # | Field | Value | Source |
|---|-------|-------|--------|
| 1 | Business Name | SENECA GLOBAL SERVICES LLC | SAM.gov / USAspending recipient profile |
...
| 9 | Business address | VA | SAM.gov not pulled |
...
| Signal | Value | Source |
|---|---|---|
| UEI | HYDWL7JCHBG4 | SAM.gov / USAspending recipient |
| CAGE code | (not pulled) | SAM.gov |
| Federal award total (trailing 5 FYs) | $30,032,110 | USAspending S1 |
| Federal award count | 3 | USAspending S1 |
| Place(s) of performance | MD | USAspending |
| Awarding agencies sampled | (none) | USAspending |
| Class-1 keyword tier | **core** | hits: ASL, CART |
| Website | https://senecanationgroup.com/companies/seneca-global-services/ (Live) | SAM.gov entityURL + curl health-check |
...
### 1. Executive Summary
SENECA GLOBAL SERVICES LLC is a core Class-1 Applied Development roll-up add-on candidate, surfaced via U.S. government open data (USAspending federal-award discovery on NAICS 541930 / PSC R608). The company has **$30,032,110** in federal contracts (trailing 5 FYs, 3 awards) with awarding agencies including multiple federal customers. The keyword strategy from `config/offmarket_sources.md` matched on: ASL, CART. The company is **not for sale** — outreach must be proprietary-approach, not broker-mediated.

### 2. Industry & Geography Gate
NAICS 541930 (Translation and Interpretation Services — includes sign-language services per 2022 NAICS definition) is a recognized Applied Development add-on target industry. Place of performance: MD. Physical headquarters: , VA. Priority geography (DC/VA/MD/PA/WV — B1 Phase 1)
...
No disclosed P&L; gov-contract revenue is a **size signal**, not an audited financial. Federal awards totaling $30,032,110 over the trailing 5 FYs suggest a mid-market firm by federal-contracting volume, but commercial revenue and non-federal sources are unknown.

### 5. Operations & Team
Insufficient data from public gov sources — fill in via post-outreach diligence. SAM.gov POC: (not disclosed in public tier). Website: https://senecanationgroup.com/companies/seneca-global-services/ (Live).
...
- USAspending recipient profile: `https://www.usaspending.gov/recipient/9515182c-9747-d27e-b80f-6610b179fede-C/latest`
- USAspending award search (NAICS 541930 + PSC R608, FY22–26)

- Website health-check (curl): 200 https://senecanationgroup.com/companies/seneca-global-services/
