# Parliament Capital Management — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Parliament Capital Management | SBA SBIC Directory ("Managed by") |
| Location (city, state) | San Juan, PR | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $68,463,000 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Rodolfo Sanchez-Colberg — rs@parliamentcapital.com — (787) 200-9004 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Parliament SBIC Growth Fund, LP** — vintage 2023, size $68,463,000, avg inv $1,223,687, strategy: Hybrid Debt/Equity, style: Private Credit, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $68,463,000 of committed capital, a typical mgmt-fee yield is in the rough range of **$1,026,945–$1,711,575 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.

### 4. Investment Strategy & Activity
Strategies on file: Hybrid Debt/Equity. Fund styles: Private Credit. Active for new investments: **Yes** — an active GP suggests an ongoing economic engine.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Parliament Capital Management" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Rodolfo Sanchez-Colberg.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: rs@parliamentcapital.com.
