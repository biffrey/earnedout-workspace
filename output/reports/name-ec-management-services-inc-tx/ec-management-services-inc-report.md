# EC Management Services, Inc. — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | EC Management Services, Inc. | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Austin, TX | SBA SBIC Directory |
| # licensed funds under this GP | 2 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $605,722,295 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | William Schell — tony@escalatecapital.com — (512) 695-4502 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Escalate Capital IV, LP** — vintage 2019, size $287,936,685, avg inv $3,942,619, strategy: Mezzanine, style: Private Equity, making new investments: No
- **Escalate Capital V, LP** — vintage 2024, size $317,785,610, avg inv $0, strategy: Mezzanine, style: Private Equity, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $605,722,295 of committed capital, a typical mgmt-fee yield is in the rough range of **$9,085,834–$15,143,057 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "EC Management Services, Inc." and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: William Schell.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: tony@escalatecapital.com.
