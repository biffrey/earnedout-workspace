# Capitala — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Capitala | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Charlotte, NC | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $231,220,000 | SBA SBIC Directory |
...
- **Capitala SBIC Fund VI, L.P.** — vintage 2023, size $231,220,000, avg inv $4,597,280, strategy: Multiple, style: Hybrid, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $231,220,000 of committed capital, a typical mgmt-fee yield is in the rough range of **$3,468,300–$5,780,500 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Capitala" and any of its licensed fund names.
