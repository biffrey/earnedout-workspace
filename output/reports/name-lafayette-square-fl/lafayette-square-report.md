# Lafayette Square — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Lafayette Square | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Miami, FL | SBA SBIC Directory |
| # licensed funds under this GP | 2 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $161,422,500 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Seren Tahiroglu — tahiroglu@lafayettesquare.com — 860.869.2778 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Lafayette Square SBIC, LP** — vintage 2023, size $73,922,500, avg inv $4,919,731, strategy: Mezzanine, style: Hybrid, making new investments: Yes
- **Lafayette Square SSBIC, LP** — vintage 2024, size $87,500,000, avg inv $4,919,731, strategy: Balanced Venture, style: Private Credit, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $161,422,500 of committed capital, a typical mgmt-fee yield is in the rough range of **$2,421,337–$4,035,562 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.

### 4. Investment Strategy & Activity
Strategies on file: Balanced Venture, Mezzanine. Fund styles: Hybrid, Private Credit. Active for new investments: **Yes** — an active GP suggests an ongoing economic engine.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Lafayette Square" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Seren Tahiroglu.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: tahiroglu@lafayettesquare.com.
