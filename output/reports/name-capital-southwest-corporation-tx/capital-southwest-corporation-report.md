# Capital Southwest Corporation — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Capital Southwest Corporation | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Dallas, TX | SBA SBIC Directory |
| # licensed funds under this GP | 2 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $305,000,000 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Michael Sarner — msarner@capitalsouthwest.com — (214) 238-5700 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Capital Southwest SBIC I, L.P.** — vintage 2021, size $217,500,000, avg inv $5,773,137, strategy: Direct Lending, style: Private Credit, making new investments: Yes
- **Capital Southwest SBIC II, LP** — vintage 2025, size $87,500,000, avg inv $0, strategy: Direct Lending, style: Private Credit, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $305,000,000 of committed capital, a typical mgmt-fee yield is in the rough range of **$4,575,000–$7,625,000 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Capital Southwest Corporation" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Michael Sarner.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: msarner@capitalsouthwest.com.
