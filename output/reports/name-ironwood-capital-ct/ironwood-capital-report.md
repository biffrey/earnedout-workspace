# Ironwood Capital — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Ironwood Capital | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Avon, CT | SBA SBIC Directory |
| # licensed funds under this GP | 3 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $261,938,626 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Carolyn Galiette — galiette@ironwoodcap.com — (860) 409-2101 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Ironwood Capital Partners V SBIC, L.P.** — vintage 2022, size $133,955,551, avg inv $2,231,884, strategy: Mezzanine, style: Hybrid, making new investments: Yes
- **Ironwood Mezzanine Fund III-A LP** — vintage 2012, size $49,138,000, avg inv $982,688, strategy: Mezzanine, style: Private Credit, making new investments: No
- **Ironwood Mezzanine Fund IV-A, L.P.** — vintage 2017, size $78,845,075, avg inv $1,596,735, strategy: Mezzanine, style: Hybrid, making new investments: No
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $261,938,626 of committed capital, a typical mgmt-fee yield is in the rough range of **$3,929,079–$6,548,465 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Ironwood Capital" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Carolyn Galiette.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: galiette@ironwoodcap.com.
