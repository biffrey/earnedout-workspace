# Vocap Investment Partners — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Vocap Investment Partners | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Vero Beach, FL | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $115,267,500 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Michael Becker — mike@vocap.vc — 404-386-0890 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Vocap Partners IV SBIC, L.P.** — vintage 2025, size $115,267,500, avg inv $0, strategy: Growth Equity, style: Venture, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $115,267,500 of committed capital, a typical mgmt-fee yield is in the rough range of **$1,729,012–$2,881,687 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.

### 4. Investment Strategy & Activity
Strategies on file: Growth Equity. Fund styles: Venture. Active for new investments: **Yes** — an active GP suggests an ongoing economic engine.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Vocap Investment Partners" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Michael Becker.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: mike@vocap.vc.
