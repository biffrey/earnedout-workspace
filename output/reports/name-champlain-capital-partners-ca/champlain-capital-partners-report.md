# Champlain Capital Partners — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Champlain Capital Partners | SBA SBIC Directory ("Managed by") |
| Location (city, state) | San Francisco, CA | SBA SBIC Directory |
| # licensed funds under this GP | 3 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $547,068,514 | SBA SBIC Directory |
| Earliest fund vintage | 2014 | SBA SBIC Directory |
| Latest fund vintage | 2023 | SBA SBIC Directory |
...
| Fund styles | Growth Equity, Hybrid | SBA SBIC Directory |
| Investor Relations contact (primary) | Dennis Leary — dleary@champlaincapital.com — (415) 281-4181 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Champlain Capital Partners II, L.P.** — vintage 2014, size $61,871,194, avg inv $2,325,688, strategy: Hybrid Debt/Equity, style: Hybrid, making new investments: No
- **Champlain Capital Partners III, L.P.** — vintage 2019, size $260,200,000, avg inv $5,684,023, strategy: Growth Equity, style: Growth Equity, making new investments: No
- **Champlain Capital Partners IV, L.P.** — vintage 2023, size $224,997,320, avg inv $14,237,899, strategy: Growth Equity, style: Growth Equity, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $547,068,514 of committed capital, a typical mgmt-fee yield is in the rough range of **$8,206,027–$13,676,712 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.

### 4. Investment Strategy & Activity
Strategies on file: Growth Equity, Hybrid Debt/Equity. Fund styles: Growth Equity, Hybrid. Active for new investments: **Yes** — an active GP suggests an ongoing economic engine.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Champlain Capital Partners" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Dennis Leary.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: dleary@champlaincapital.com.
