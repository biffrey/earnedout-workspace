# Invision Management, Inc. — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Invision Management, Inc. | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Chicago, IL | SBA SBIC Directory |
| # licensed funds under this GP | 2 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $482,761,619 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Robert Castillo — rcastillo@invcg.com — (312) 543-2430 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Invision Capital II, L.P.** — vintage 2016, size $240,536,619, avg inv $4,663,562, strategy: Buyout, style: Hybrid, making new investments: No
- **Invision Capital III-A, L.P.** — vintage 2022, size $242,225,000, avg inv $4,878,500, strategy: Buyout, style: Hybrid, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $482,761,619 of committed capital, a typical mgmt-fee yield is in the rough range of **$7,241,424–$12,069,040 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Invision Management, Inc." and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Robert Castillo.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: rcastillo@invcg.com.
