# RFE Management Corporation — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | RFE Management Corporation | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Westport, CT | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $55,080,000 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | James Parsons — jparsons@rfeip.com — 203-966-2800 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **RFE Investment Partners X, L.P.** — vintage 2026, size $55,080,000, avg inv $0, strategy: Buyout, style: Private Equity, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $55,080,000 of committed capital, a typical mgmt-fee yield is in the rough range of **$826,200–$1,377,000 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "RFE Management Corporation" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: James Parsons.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: jparsons@rfeip.com.
