# Zions — SBIC Prospect Evaluation
...
| 3 | 10+ years in business | ✅ | earliest fund vintage 2001 (~25 yrs of SBIC history) |
...
| Field | Value | Source |
|---|---|---|
| Management entity | Zions | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Salt Lake City, UT | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $100,000,000 | SBA SBIC Directory |
| Earliest fund vintage | 2001 | SBA SBIC Directory |
| Latest fund vintage | 2001 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Nick Efstratis — epic@cornerstone.vc — (801) 524-8939 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Zions SBIC, L.L.C.** — vintage 2001, size $100,000,000, avg inv $533,925, strategy: Hybrid Debt/Equity, style: Hybrid, making new investments: No
...
| 3 | Years in business | **10** | earliest fund vintage 2001 (~25 yrs of SBIC history) |
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $100,000,000 of committed capital, a typical mgmt-fee yield is in the rough range of **$1,500,000–$2,500,000 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Zions" and any of its licensed fund names.
