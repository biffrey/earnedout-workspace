# TRANSLATION EXCELLENCE INC. — Prospect Evaluation
...
| # | Field | Value | Source |
|---|-------|-------|--------|
| 1 | Business Name | TRANSLATION EXCELLENCE INC. | SAM.gov / USAspending recipient profile |
...
| 9 | Business address | CO | SAM.gov not pulled |
...
| Signal | Value | Source |
|---|---|---|
| UEI | LSEHC45NMB28 | SAM.gov / USAspending recipient |
| CAGE code | (not pulled) | SAM.gov |
| Federal award total (trailing 5 FYs) | $48,485,698 | USAspending S1 |
| Federal award count | 13 | USAspending S1 |
| Place(s) of performance | CO, DC, GA, MD | USAspending |
| Awarding agencies sampled | (none) | USAspending |
| Class-1 keyword tier | **core** | hits: SIGN LANGUAGE |
| Website | https://www.translationexcellence.com (Live) | SAM.gov entityURL + curl health-check |
...
### 1. Executive Summary
TRANSLATION EXCELLENCE INC. is a core Class-1 Applied Development roll-up add-on candidate, surfaced via U.S. government open data (USAspending federal-award discovery on NAICS 541930 / PSC R608). The company has **$48,485,698** in federal contracts (trailing 5 FYs, 13 awards) with awarding agencies including multiple federal customers. The keyword strategy from `config/offmarket_sources.md` matched on: SIGN LANGUAGE. The company is **not for sale** — outreach must be proprietary-approach, not broker-mediated.

### 2. Industry & Geography Gate
NAICS 541930 (Translation and Interpretation Services — includes sign-language services per 2022 NAICS definition) is a recognized Applied Development add-on target industry. Place of performance: CO, DC, GA, MD. Physical headquarters: , CO. Not a B1 priority state, but no exclusion.
...
No disclosed P&L; gov-contract revenue is a **size signal**, not an audited financial. Federal awards totaling $48,485,698 over the trailing 5 FYs suggest a mid-market firm by federal-contracting volume, but commercial revenue and non-federal sources are unknown.

### 5. Operations & Team
Insufficient data from public gov sources — fill in via post-outreach diligence. SAM.gov POC: (not disclosed in public tier). Website: https://www.translationexcellence.com (Live).
...
- USAspending recipient profile: `https://www.usaspending.gov/recipient/4b7782a3-fead-45c1-c503-62a27d415340-C/latest`
- USAspending award search (NAICS 541930 + PSC R608, FY22–26)

- Website health-check (curl): 200 https://translationexcellence.com/
