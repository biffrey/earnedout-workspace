# LongueVue Management Company, LLC — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | LongueVue Management Company, LLC | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Metairie, LA | SBA SBIC Directory |
| # licensed funds under this GP | 2 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $493,619,200 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Max Vorhoff — mvorhoff@lvcpartners.com — (504) 293-3610 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **LongueVue Capital Partners III, L.P** — vintage 2017, size $221,119,200, avg inv $4,199,151, strategy: Buyout, style: Growth Equity, making new investments: No
- **LongueVue Capital Partners IV, L.P.** — vintage 2022, size $272,500,000, avg inv $6,188,664, strategy: Buyout, style: Growth Equity, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $493,619,200 of committed capital, a typical mgmt-fee yield is in the rough range of **$7,404,288–$12,340,480 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "LongueVue Management Company, LLC" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Max Vorhoff.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: mvorhoff@lvcpartners.com.
