# Hercules Capital, Inc. — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Hercules Capital, Inc. | SBA SBIC Directory ("Managed by") |
| Location (city, state) | San Mateo, CA | SBA SBIC Directory |
| # licensed funds under this GP | 2 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $525,000,000 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Seth Meyer — smeyer@htgc.com — (857) 206-8966 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Hercules Capital IV, L.P.** — vintage 2020, size $262,500,000, avg inv $10,798,246, strategy: Direct Lending, style: Private Credit, making new investments: Yes
- **Hercules SBIC V, L.P.** — vintage 2024, size $262,500,000, avg inv $11,250,000, strategy: Direct Lending, style: Private Credit, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $525,000,000 of committed capital, a typical mgmt-fee yield is in the rough range of **$7,875,000–$13,125,000 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Hercules Capital, Inc." and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Seth Meyer.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: smeyer@htgc.com.
