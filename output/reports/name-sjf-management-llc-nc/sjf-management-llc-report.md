# SJF Management LLC — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | SJF Management LLC | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Durham, NC | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $78,803,030 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | David A. Kirkpatrick — dkirk@sjfventures.com — (919) 530-1177 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **SJF Ventures III, LP** — vintage 2012, size $78,803,030, avg inv $495,549, strategy: Venture, style: Venture, making new investments: No
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $78,803,030 of committed capital, a typical mgmt-fee yield is in the rough range of **$1,182,045–$1,970,075 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "SJF Management LLC" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: David A. Kirkpatrick.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: dkirk@sjfventures.com.
