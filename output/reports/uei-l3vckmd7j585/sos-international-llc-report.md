# SOS INTERNATIONAL LLC — Prospect Evaluation
...
| # | Field | Value | Source |
|---|-------|-------|--------|
| 1 | Business Name | SOS INTERNATIONAL LLC | SAM.gov / USAspending recipient profile |
...
| Signal | Value | Source |
|---|---|---|
| UEI | L3VCKMD7J585 | SAM.gov / USAspending recipient |
| CAGE code | (not pulled) | SAM.gov |
| Federal award total (trailing 5 FYs) | $731,938,212 | USAspending S1 |
| Federal award count | 24 | USAspending S1 |
| Place(s) of performance | FL, SC, VA | USAspending |
| Awarding agencies sampled | (none) | USAspending |
| Class-1 keyword tier | **core** | hits: VRI |
| Website | https://sosi.com/ (Live) | SAM.gov entityURL + curl health-check |
...
### 1. Executive Summary
SOS INTERNATIONAL LLC is a core Class-1 Applied Development roll-up add-on candidate, surfaced via U.S. government open data (USAspending federal-award discovery on NAICS 541930 / PSC R608). The company has **$731,938,212** in federal contracts (trailing 5 FYs, 24 awards) with awarding agencies including multiple federal customers. The keyword strategy from `config/offmarket_sources.md` matched on: VRI. The company is **not for sale** — outreach must be proprietary-approach, not broker-mediated.

### 2. Industry & Geography Gate
NAICS 541930 (Translation and Interpretation Services — includes sign-language services per 2022 NAICS definition) is a recognized Applied Development add-on target industry. Place of performance: FL, SC, VA. Physical headquarters: , VA. Priority geography (DC/VA/MD/PA/WV — B1 Phase 1)
...
No disclosed P&L; gov-contract revenue is a **size signal**, not an audited financial. Federal awards totaling $731,938,212 over the trailing 5 FYs suggest a large mid-market firm by federal-contracting volume, but commercial revenue and non-federal sources are unknown.

### 5. Operations & Team
Insufficient data from public gov sources — fill in via post-outreach diligence. SAM.gov POC: (not disclosed in public tier). Website: https://sosi.com/ (Live).
...
- USAspending recipient profile: `https://www.usaspending.gov/recipient/aee3ebde-7484-0fac-c8b8-43896b620d02-C/latest`
- USAspending award search (NAICS 541930 + PSC R608, FY22–26)

- Website health-check (curl): 200 https://sosi.com/
