# Innovate Capital Partners LLC — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Innovate Capital Partners LLC | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Philadelphia, PA | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $23,270,330 | SBA SBIC Directory |
...
| Investment strategies | Expansion | SBA SBIC Directory |
| Fund styles | Private Equity | SBA SBIC Directory |
| Investor Relations contact (primary) | Della Clark — dclark@theenterprisecenter.com — (215) 895-4005 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Innovate Capital Growth Fund, L.P.** — vintage 2022, size $23,270,330, avg inv $2,000,000, strategy: Expansion, style: Private Equity, making new investments: Yes
...
### 1. Executive Summary
Innovate Capital Partners LLC is a licensed SBIC general partner / management entity headquartered in Philadelphia, PA that manages **1 licensed SBIC fund(s)** with **$23,270,330** of total committed capital across vintages 2022–2022. The acquisition target here is the **management entity that holds the SBIC license**, not the portfolio companies. The strategic rationale is acquiring an SBIC license already in good standing — short-circuiting the multi-year de novo SBA SBIC licensing process. **The company is not for sale**; outreach must be proprietary-approach via Template OM-2.
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $23,270,330 of committed capital, a typical mgmt-fee yield is in the rough range of **$349,054–$581,758 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.

### 4. Investment Strategy & Activity
Strategies on file: Expansion. Fund styles: Private Equity. Active for new investments: **Yes** — an active GP suggests an ongoing economic engine.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Innovate Capital Partners LLC" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Della Clark.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: dclark@theenterprisecenter.com.
