# Plexus Capital, LLC — SBIC Prospect Evaluation
...
| 3 | 10+ years in business | ⚠️ | earliest fund vintage 2017 (~9 yrs of SBIC history) |
...
| Field | Value | Source |
|---|---|---|
| Management entity | Plexus Capital, LLC | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Raleigh, NC | SBA SBIC Directory |
| # licensed funds under this GP | 8 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $1,080,976,032 | SBA SBIC Directory |
| Earliest fund vintage | 2017 | SBA SBIC Directory |
| Latest fund vintage | 2025 | SBA SBIC Directory |
| Any fund making new investments? | Yes | SBA SBIC Directory |
| Investment strategies | Hybrid Debt/Equity, Mezzanine | SBA SBIC Directory |
| Fund styles | Hybrid, Private Credit, Private Equity | SBA SBIC Directory |
| Investor Relations contact (primary) | Michael Painter — mpainter@plexuscap.com — (919) 256-6355 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Plexus Fund IV-A, L.P.** — vintage 2017, size $162,232,000, avg inv $1,573,632, strategy: Mezzanine, style: Hybrid, making new investments: No
- **Plexus Fund IV-B, L.P.** — vintage 2017, size $69,528,000, avg inv $678,059, strategy: Mezzanine, style: Hybrid, making new investments: No
- **Plexus Fund IV-C, L.P.** — vintage 2017, size $77,677,196, avg inv $752,523, strategy: Mezzanine, style: Hybrid, making new investments: No
- **Plexus Fund V-A, LP** — vintage 2020, size $250,000,000, avg inv $1,636,683, strategy: Hybrid Debt/Equity, style: Private Equity, making new investments: Yes
- **Plexus Fund V-B, LP** — vintage 2020, size $99,763,840, avg inv $636,812, strategy: Hybrid Debt/Equity, style: Private Equity, making new investments: Yes
- **Plexus Fund V-C, L.P.** — vintage 2020, size $72,387,498, avg inv $476,486, strategy: Mezzanine, style: Hybrid, making new investments: Yes
- **Plexus Fund V-C, LP** — vintage 2020, size $72,387,498, avg inv $0, strategy: Hybrid Debt/Equity, style: Private Equity, making new investments: Yes
- **Plexus Fund VII-A, L.P.** — vintage 2025, size $277,000,000, avg inv $0, strategy: Hybrid Debt/Equity, style: Private Credit, making new investments: Yes
...
| 3 | Years in business | **0** | earliest fund vintage 2017 (~9 yrs of SBIC history) |
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $1,080,976,032 of committed capital, a typical mgmt-fee yield is in the rough range of **$16,214,640–$27,024,400 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.

### 4. Investment Strategy & Activity
Strategies on file: Hybrid Debt/Equity, Mezzanine. Fund styles: Hybrid, Private Credit, Private Equity. Active for new investments: **Yes** — an active GP suggests an ongoing economic engine.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Plexus Capital, LLC" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Michael Painter.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: mpainter@plexuscap.com.
