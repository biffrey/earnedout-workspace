# Cyprium Investment Partners — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Cyprium Investment Partners | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Cleveland, OH | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $59,975,000 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Daniel Kessler — dkessler@cyprium.com — (216) 453-4533 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Cyprium SBIC I, L.P.** — vintage 2023, size $59,975,000, avg inv $4,375,000, strategy: Mezzanine, style: Hybrid, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $59,975,000 of committed capital, a typical mgmt-fee yield is in the rough range of **$899,625–$1,499,375 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Cyprium Investment Partners" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Daniel Kessler.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: dkessler@cyprium.com.
