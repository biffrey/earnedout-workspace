# Bluhaus Capital — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Bluhaus Capital | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Guaynabo, PR | SBA SBIC Directory |
| # licensed funds under this GP | 2 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $70,649,876 | SBA SBIC Directory |
...
| Investment strategies | Buyout, Multiple | SBA SBIC Directory |
| Fund styles | Hybrid, Private Credit | SBA SBIC Directory |
| Investor Relations contact (primary) | Eduardo Inclan — einclan@bhcapllc.com — (787) 708-6747 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Bluhaus Small Business Fund II, LP** — vintage 2024, size $20,024,876, avg inv $0, strategy: Multiple, style: Hybrid, making new investments: Yes
- **Bluhaus Small Business Fund, L.P.** — vintage 2020, size $50,625,000, avg inv $1,565,345, strategy: Buyout, style: Private Credit, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $70,649,876 of committed capital, a typical mgmt-fee yield is in the rough range of **$1,059,748–$1,766,246 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.

### 4. Investment Strategy & Activity
Strategies on file: Buyout, Multiple. Fund styles: Hybrid, Private Credit. Active for new investments: **Yes** — an active GP suggests an ongoing economic engine.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Bluhaus Capital" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Eduardo Inclan.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: einclan@bhcapllc.com.
