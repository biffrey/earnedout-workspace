# First Capital Partners — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | First Capital Partners | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Omaha, NE | SBA SBIC Directory |
| # licensed funds under this GP | 2 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $233,635,315 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Andrew Kemp — akemp@firstcapitalpartners.com — (402) 718-8868 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **FCP Fund II, L.P.** — vintage 2011, size $84,200,000, avg inv $522,844, strategy: Hybrid Debt/Equity, style: Hybrid, making new investments: No
- **FCP Fund III, L.P.** — vintage 2018, size $149,435,315, avg inv $2,522,448, strategy: Hybrid Debt/Equity, style: Hybrid, making new investments: No
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $233,635,315 of committed capital, a typical mgmt-fee yield is in the rough range of **$3,504,529–$5,840,882 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.

### 4. Investment Strategy & Activity
Strategies on file: Hybrid Debt/Equity. Fund styles: Hybrid. Active for new investments: **No (winding down)** — a wind-down GP may indicate willingness to monetize the management entity, including the SBIC license.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "First Capital Partners" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Andrew Kemp.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: akemp@firstcapitalpartners.com.
