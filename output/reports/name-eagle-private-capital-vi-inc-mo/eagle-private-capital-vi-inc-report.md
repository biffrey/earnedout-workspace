# Eagle Private Capital VI, Inc — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Eagle Private Capital VI, Inc | SBA SBIC Directory ("Managed by") |
| Location (city, state) | St. Louis, MO | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $299,441,311 | SBA SBIC Directory |
...
- **Eagle Fund VI-A, LP** — vintage 2024, size $299,441,311, avg inv $6,764,531, strategy: Mezzanine, style: Hybrid, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $299,441,311 of committed capital, a typical mgmt-fee yield is in the rough range of **$4,491,619–$7,486,032 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Eagle Private Capital VI, Inc" and any of its licensed fund names.
