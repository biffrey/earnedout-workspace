# Rochefort Asset Management LLC — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Rochefort Asset Management LLC | SBA SBIC Directory ("Managed by") |
| Location (city, state) | West Palm Beach, FL | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $278,090,000 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Steele Schottenheimer — ss@haymancapital.com — 917-916-6224 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Rochefort Ventures LP** — vintage 2024, size $278,090,000, avg inv $21,900,000, strategy: Direct Lending, style: Private Credit, making new investments: Yes
...
### 1. Executive Summary
Rochefort Asset Management LLC is a licensed SBIC general partner / management entity headquartered in West Palm Beach, FL that manages **1 licensed SBIC fund(s)** with **$278,090,000** of total committed capital across vintages 2024–2024. The acquisition target here is the **management entity that holds the SBIC license**, not the portfolio companies. The strategic rationale is acquiring an SBIC license already in good standing — short-circuiting the multi-year de novo SBA SBIC licensing process. **The company is not for sale**; outreach must be proprietary-approach via Template OM-2.
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $278,090,000 of committed capital, a typical mgmt-fee yield is in the rough range of **$4,171,350–$6,952,250 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Rochefort Asset Management LLC" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Steele Schottenheimer.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: ss@haymancapital.com.
