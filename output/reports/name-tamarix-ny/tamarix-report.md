# Tamarix — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Tamarix | SBA SBIC Directory ("Managed by") |
| Location (city, state) | New York, NY | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $120,345,786 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Mark Hauser — mhauser@tamarixcapital.com — (212) 430-8400 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Tamarix Capital Partners II, L.P.** — vintage 2022, size $120,345,786, avg inv $8,619,375, strategy: Hybrid Debt/Equity, style: Hybrid, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $120,345,786 of committed capital, a typical mgmt-fee yield is in the rough range of **$1,805,186–$3,008,644 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Tamarix" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Mark Hauser.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: mhauser@tamarixcapital.com.
