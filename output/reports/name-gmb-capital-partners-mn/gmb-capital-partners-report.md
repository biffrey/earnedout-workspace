# GMB Capital Partners — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | GMB Capital Partners | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Minneapolis, MN | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $333,661,375 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Tom Kreimer — tkreimer@gmbmezz.com — (612) 243-4405 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **GMB Mezzanine Capital V, L.P.** — vintage 2023, size $333,661,375, avg inv $5,943,143, strategy: Mezzanine, style: Private Credit, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $333,661,375 of committed capital, a typical mgmt-fee yield is in the rough range of **$5,004,920–$8,341,534 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "GMB Capital Partners" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Tom Kreimer.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: tkreimer@gmbmezz.com.
