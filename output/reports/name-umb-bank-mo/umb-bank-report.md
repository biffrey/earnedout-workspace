# UMB Bank — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | UMB Bank | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Kansas City, MO | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $53,410,000 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Tedd Carew — tedd.carew@umb.com — (816) 860-1575 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **UMB Capital Corporation** — vintage 1983, size $53,410,000, avg inv $1,108,635, strategy: Hybrid Debt/Equity, style: Hybrid, making new investments: No
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $53,410,000 of committed capital, a typical mgmt-fee yield is in the rough range of **$801,150–$1,335,250 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "UMB Bank" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Tedd Carew.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: tedd.carew@umb.com.
