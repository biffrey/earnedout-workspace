# Multiplier Capital, LLC — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Multiplier Capital, LLC | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Washington, DC | SBA SBIC Directory |
| # licensed funds under this GP | 2 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $322,063,948 | SBA SBIC Directory |
...
| Investment strategies | Balanced Venture, Mezzanine | SBA SBIC Directory |
| Fund styles | Private Credit | SBA SBIC Directory |
| Investor Relations contact (primary) | Kevin Sheehan — sheehan@multipliercapital.com — (917)783-3223 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Multiplier Capital II, L.P** — vintage 2017, size $190,450,448, avg inv $5,082,710, strategy: Mezzanine, style: Private Credit, making new investments: No
- **Multiplier Capital III, L.P.** — vintage 2022, size $131,613,500, avg inv $9,450,000, strategy: Balanced Venture, style: Private Credit, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $322,063,948 of committed capital, a typical mgmt-fee yield is in the rough range of **$4,830,959–$8,051,598 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.

### 4. Investment Strategy & Activity
Strategies on file: Balanced Venture, Mezzanine. Fund styles: Private Credit. Active for new investments: **Yes** — an active GP suggests an ongoing economic engine.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Multiplier Capital, LLC" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Kevin Sheehan.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: sheehan@multipliercapital.com.
