# Spring Capital Partners — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Spring Capital Partners | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Lutherville, MD | SBA SBIC Directory |
| # licensed funds under this GP | 2 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $241,737,770 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | John Acker — jca@springcap.com — (410) 685-8007 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Spring Capital Partners III, L.P.** — vintage 2013, size $58,237,770, avg inv $1,901,184, strategy: Mezzanine, style: Private Credit, making new investments: No
- **Spring Capital Partners IV, L.P.** — vintage 2020, size $183,500,000, avg inv $3,302,355, strategy: Mezzanine, style: Private Credit, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $241,737,770 of committed capital, a typical mgmt-fee yield is in the rough range of **$3,626,066–$6,043,444 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Spring Capital Partners" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: John Acker.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: jca@springcap.com.
