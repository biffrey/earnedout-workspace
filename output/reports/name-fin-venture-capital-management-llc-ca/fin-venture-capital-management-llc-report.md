# Fin Venture Capital Management LLC — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Fin Venture Capital Management LLC | SBA SBIC Directory ("Managed by") |
| Location (city, state) | San Francisco, CA | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $2,500,000 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Logan Allin — logan@fin.capital — 415-300-0702 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Fin Capital Flagship III - SBIC, LP** — vintage 2026, size $2,500,000, avg inv $0, strategy: Venture, style: Venture, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $2,500,000 of committed capital, a typical mgmt-fee yield is in the rough range of **$37,500–$62,500 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Fin Venture Capital Management LLC" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Logan Allin.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: logan@fin.capital.
