# Caltius Structured Capital — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Caltius Structured Capital | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Los Angeles, CA | SBA SBIC Directory |
| # licensed funds under this GP | 4 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $574,090,000 | SBA SBIC Directory |
...
| Investment strategies | Mezzanine, Multiple | SBA SBIC Directory |
| Fund styles | Hybrid, Private Credit, Private Equity | SBA SBIC Directory |
| Investor Relations contact (primary) | James B. Upchurch — jupchurch@caltius.com — 310-996-9572 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Caltius Equity Partners V, LP** — vintage 2025, size $106,825,000, avg inv $0, strategy: Multiple, style: Private Equity, making new investments: Yes
- **Caltius Partners V (SBIC), L.P.** — vintage 2016, size $139,500,000, avg inv $4,990,952, strategy: Mezzanine, style: Hybrid, making new investments: No
- **Caltius Partners V (SBIC), LP** — vintage 2016, size $78,675,000, avg inv $0, strategy: Multiple, style: Private Credit, making new investments: Yes
- **Caltius Partners VI (SBIC), L.P.** — vintage 2022, size $249,090,000, avg inv $5,220,646, strategy: Mezzanine, style: Hybrid, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $574,090,000 of committed capital, a typical mgmt-fee yield is in the rough range of **$8,611,350–$14,352,250 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.

### 4. Investment Strategy & Activity
Strategies on file: Mezzanine, Multiple. Fund styles: Hybrid, Private Credit, Private Equity. Active for new investments: **Yes** — an active GP suggests an ongoing economic engine.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Caltius Structured Capital" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: James B. Upchurch.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: jupchurch@caltius.com.
