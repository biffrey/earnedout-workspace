# Centerfield Capital Partners — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Centerfield Capital Partners | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Indianapolis, IN | SBA SBIC Directory |
| # licensed funds under this GP | 2 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $556,609,930 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Faraz Abbasi — faraz@centerfieldcapital.com — (317) 513-2763 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **CCP IV-SBIC, L.P.** — vintage 2016, size $251,861,732, avg inv $2,982,415, strategy: Mezzanine, style: Private Credit, making new investments: No
- **CCP V-SBIC, L.P.** — vintage 2022, size $304,748,198, avg inv $5,759,593, strategy: Mezzanine, style: Hybrid, making new investments: Yes
...
### 1. Executive Summary
Centerfield Capital Partners is a licensed SBIC general partner / management entity headquartered in Indianapolis, IN that manages **2 licensed SBIC fund(s)** with **$556,609,930** of total committed capital across vintages 2016–2022. The acquisition target here is the **management entity that holds the SBIC license**, not the portfolio companies. The strategic rationale is acquiring an SBIC license already in good standing — short-circuiting the multi-year de novo SBA SBIC licensing process. **The company is not for sale**; outreach must be proprietary-approach via Template OM-2.
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $556,609,930 of committed capital, a typical mgmt-fee yield is in the rough range of **$8,349,148–$13,915,248 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Centerfield Capital Partners" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Faraz Abbasi.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: faraz@centerfieldcapital.com.
