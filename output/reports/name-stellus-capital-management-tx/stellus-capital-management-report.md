# Stellus Capital Management — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Stellus Capital Management | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Houston, TX | SBA SBIC Directory |
| # licensed funds under this GP | 2 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $487,500,000 | SBA SBIC Directory |
...
| Investment strategies | Balanced Venture, Hybrid Debt/Equity | SBA SBIC Directory |
| Fund styles | Hybrid | SBA SBIC Directory |
| Investor Relations contact (primary) | W. Todd Huskinson — thuskinson@stelluscapital.com — (713) 292-5414 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Stellus Capital SBIC II LP** — vintage 2019, size $262,500,000, avg inv $7,672,843, strategy: Balanced Venture, style: Hybrid, making new investments: No
- **Stellus Capital SBIC LP** — vintage 2014, size $225,000,000, avg inv $6,944,885, strategy: Hybrid Debt/Equity, style: Hybrid, making new investments: No
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $487,500,000 of committed capital, a typical mgmt-fee yield is in the rough range of **$7,312,500–$12,187,500 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.

### 4. Investment Strategy & Activity
Strategies on file: Balanced Venture, Hybrid Debt/Equity. Fund styles: Hybrid. Active for new investments: **No (winding down)** — a wind-down GP may indicate willingness to monetize the management entity, including the SBIC license.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Stellus Capital Management" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: W. Todd Huskinson.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: thuskinson@stelluscapital.com.
