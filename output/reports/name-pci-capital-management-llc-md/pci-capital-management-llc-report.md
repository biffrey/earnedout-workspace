# PCI Capital Management, LLC — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | PCI Capital Management, LLC | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Baltimore, MD | SBA SBIC Directory |
| # licensed funds under this GP | 2 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $133,743,000 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Christopher Pope — cpope@parkway.calvertst.com — (443) 573-3714 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **PCI II, L.P.** — vintage 2020, size $105,228,000, avg inv $3,374,032, strategy: Hybrid Debt/Equity, style: Private Credit, making new investments: Yes
- **PCI III, L.P.** — vintage 2025, size $28,515,000, avg inv $0, strategy: Hybrid Debt/Equity, style: Private Credit, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $133,743,000 of committed capital, a typical mgmt-fee yield is in the rough range of **$2,006,145–$3,343,575 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "PCI Capital Management, LLC" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Christopher Pope.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: cpope@parkway.calvertst.com.
