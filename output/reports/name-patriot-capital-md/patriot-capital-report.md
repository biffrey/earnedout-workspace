# Patriot Capital — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Patriot Capital | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Baltimore, MD | SBA SBIC Directory |
| # licensed funds under this GP | 3 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $588,805,718 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Charles McCusker — cmccusker@patriot-capital.com — (443) 573-3015 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Patriot Capital III SBIC, L.P.** — vintage 2013, size $105,526,801, avg inv $2,509,818, strategy: Mezzanine, style: Hybrid, making new investments: No
- **Patriot Capital IV (A), L.P.** — vintage 2018, size $302,972,498, avg inv $3,107,558, strategy: Mezzanine, style: Hybrid, making new investments: No
- **Patriot Capital V, L.P.** — vintage 2023, size $180,306,419, avg inv $4,204,102, strategy: Mezzanine, style: Hybrid, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $588,805,718 of committed capital, a typical mgmt-fee yield is in the rough range of **$8,832,085–$14,720,142 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Patriot Capital" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Charles McCusker.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: cmccusker@patriot-capital.com.
