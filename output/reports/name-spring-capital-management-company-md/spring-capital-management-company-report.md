# Spring Capital Management Company — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Spring Capital Management Company | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Lutherville, MD | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $78,938,334 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | John Acker — jca@springcap.com — 410-685-8000 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Spring Capital Partners V, L.P.** — vintage 2025, size $78,938,334, avg inv $0, strategy: Mezzanine, style: Private Credit, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $78,938,334 of committed capital, a typical mgmt-fee yield is in the rough range of **$1,184,075–$1,973,458 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Spring Capital Management Company" and any of its licensed fund names.
