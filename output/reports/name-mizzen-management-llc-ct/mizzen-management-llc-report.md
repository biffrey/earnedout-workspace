# Mizzen Management, LLC — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Mizzen Management, LLC | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Stamford, CT | SBA SBIC Directory |
| # licensed funds under this GP | 2 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $293,995,252 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Kevin Wolpert — kwolpert@mizzencapital.com — (717) 201-1172 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Mizzen Capital III, LP** — vintage 2025, size $26,760,000, avg inv $2,833,333, strategy: Direct Lending, style: Private Credit, making new investments: Yes
- **Mizzen Capital, L.P.** — vintage 2021, size $267,235,252, avg inv $4,643,097, strategy: Direct Lending, style: Hybrid, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $293,995,252 of committed capital, a typical mgmt-fee yield is in the rough range of **$4,409,928–$7,349,881 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.

### 4. Investment Strategy & Activity
Strategies on file: Direct Lending. Fund styles: Hybrid, Private Credit. Active for new investments: **Yes** — an active GP suggests an ongoing economic engine.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Mizzen Management, LLC" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Kevin Wolpert.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: kwolpert@mizzencapital.com.
