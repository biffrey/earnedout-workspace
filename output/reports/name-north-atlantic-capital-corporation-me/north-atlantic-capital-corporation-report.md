# North Atlantic Capital Corporation — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | North Atlantic Capital Corporation | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Portland, ME | SBA SBIC Directory |
| # licensed funds under this GP | 2 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $128,924,843 | SBA SBIC Directory |
...
| Investment strategies | Mezzanine, Venture | SBA SBIC Directory |
| Fund styles | Hybrid | SBA SBIC Directory |
| Investor Relations contact (primary) | David M Coit — dcoit@northatlanticcapital.com — (207) 653-1040 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **North Atlantic Venture Fund V, L.P.** — vintage 2015, size $76,390,000, avg inv $1,290,816, strategy: Mezzanine, style: Hybrid, making new investments: No
- **Stifel North Atlantic AM-Forward, LP** — vintage 2024, size $52,534,843, avg inv $6,944,885, strategy: Venture, style: Hybrid, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $128,924,843 of committed capital, a typical mgmt-fee yield is in the rough range of **$1,933,872–$3,223,121 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.

### 4. Investment Strategy & Activity
Strategies on file: Mezzanine, Venture. Fund styles: Hybrid. Active for new investments: **Yes** — an active GP suggests an ongoing economic engine.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "North Atlantic Capital Corporation" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: David M Coit.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: dcoit@northatlanticcapital.com.
