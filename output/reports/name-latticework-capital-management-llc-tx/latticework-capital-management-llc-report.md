# Latticework Capital Management, LLC — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Latticework Capital Management, LLC | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Dallas, TX | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $110,737,954 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Kyle Bradford — kyle.bradford@latticeworkcapital.com — (917) 676-6742 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **LCM Healthcare Fund I, L.P.** — vintage 2018, size $110,737,954, avg inv $3,714,616, strategy: Growth Equity, style: Growth Equity, making new investments: No
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $110,737,954 of committed capital, a typical mgmt-fee yield is in the rough range of **$1,661,069–$2,768,448 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Latticework Capital Management, LLC" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Kyle Bradford.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: kyle.bradford@latticeworkcapital.com.
