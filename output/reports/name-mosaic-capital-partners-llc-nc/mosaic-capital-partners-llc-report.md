# Mosaic Capital Partners, LLC — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Mosaic Capital Partners, LLC | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Charlotte, NC | SBA SBIC Directory |
| # licensed funds under this GP | 2 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $228,894,788 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Bill Hayes — whayes@mosaic-cp.com — 704.626.6433 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Mosaic Capital Investors I, LP** — vintage 2014, size $90,127,249, avg inv $2,581,704, strategy: Mezzanine, style: Hybrid, making new investments: No
- **Mosaic Capital Investors II SBIC, L.P.** — vintage 2024, size $138,767,539, avg inv $5,000,000, strategy: Buyout, style: Private Equity, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $228,894,788 of committed capital, a typical mgmt-fee yield is in the rough range of **$3,433,421–$5,722,369 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.

### 4. Investment Strategy & Activity
Strategies on file: Buyout, Mezzanine. Fund styles: Hybrid, Private Equity. Active for new investments: **Yes** — an active GP suggests an ongoing economic engine.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Mosaic Capital Partners, LLC" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Bill Hayes.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: whayes@mosaic-cp.com.
