# Enhanced Capital — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Enhanced Capital | SBA SBIC Directory ("Managed by") |
| Location (city, state) | New York, NY | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $60,853,834 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Michael Korengold — mkorengold@enhancedcapital.com — (212) 207-3385 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Enhanced Small Business Investment Company, L.P.** — vintage 2012, size $60,853,834, avg inv $1,797,587, strategy: Direct Lending, style: Private Credit, making new investments: No
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $60,853,834 of committed capital, a typical mgmt-fee yield is in the rough range of **$912,807–$1,521,345 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Enhanced Capital" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Michael Korengold.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: mkorengold@enhancedcapital.com.
