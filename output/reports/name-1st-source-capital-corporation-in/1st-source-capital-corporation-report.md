# 1st Source Capital Corporation — SBIC Prospect Evaluation
...
| 3 | 10+ years in business | ✅ | earliest fund vintage 1983 (~43 yrs of SBIC history) |
...
| Field | Value | Source |
|---|---|---|
| Management entity | 1st Source Capital Corporation | SBA SBIC Directory ("Managed by") |
| Location (city, state) | South Bend, IN | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $2,850,000 | SBA SBIC Directory |
| Earliest fund vintage | 1983 | SBA SBIC Directory |
| Latest fund vintage | 1983 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Ryan Fenstermaker — fenstermakerr@1stsource.com — 574-235-2180 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **1st Source Capital Corporation** — vintage 1983, size $2,850,000, avg inv $283,740, strategy: Direct Lending, style: Venture, making new investments: No
...
| 3 | Years in business | **10** | earliest fund vintage 1983 (~43 yrs of SBIC history) |
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $2,850,000 of committed capital, a typical mgmt-fee yield is in the rough range of **$42,750–$71,250 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.

### 4. Investment Strategy & Activity
Strategies on file: Direct Lending. Fund styles: Venture. Active for new investments: **No (winding down)** — a wind-down GP may indicate willingness to monetize the management entity, including the SBIC license.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "1st Source Capital Corporation" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Ryan Fenstermaker.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: fenstermakerr@1stsource.com.
