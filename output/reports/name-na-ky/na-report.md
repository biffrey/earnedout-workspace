...
| 3 | 10+ years in business | ✅ | earliest fund vintage 1978 (~48 yrs of SBIC history) |
...
| Field | Value | Source |
|---|---|---|
| Management entity | na | SBA SBIC Directory ("Managed by") |
| Location (city, state) | London, KY | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $2,081,675 | SBA SBIC Directory |
| Earliest fund vintage | 1978 | SBA SBIC Directory |
| Latest fund vintage | 1978 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Brenda McDaniels — BMcDaniel@khic.org — 606-864-5175 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Mountain Ventures, Inc.** — vintage 1978, size $2,081,675, avg inv $238,571, strategy: Direct Lending, style: Private Credit, making new investments: No
...
| 3 | Years in business | **10** | earliest fund vintage 1978 (~48 yrs of SBIC history) |
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $2,081,675 of committed capital, a typical mgmt-fee yield is in the rough range of **$31,225–$52,041 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "na" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Brenda McDaniels.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: BMcDaniel@khic.org.
