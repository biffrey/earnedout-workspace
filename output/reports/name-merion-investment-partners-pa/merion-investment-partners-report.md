# Merion Investment Partners — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Merion Investment Partners | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Berwyn, PA | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $82,512,000 | SBA SBIC Directory |
...
- **Merion Investment Partners IV, LP** — vintage 2023, size $82,512,000, avg inv $2,807,259, strategy: Mezzanine, style: Private Credit, making new investments: Yes
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Merion Investment Partners" and any of its licensed fund names.
