...
| # | Field | Value | Source |
|---|-------|-------|--------|
| 1 | Business Name | VANCRO | SAM.gov / USAspending recipient profile |
...
| 9 | Business address | WA | SAM.gov not pulled |
...
| Signal | Value | Source |
|---|---|---|
| UEI | JZNMT9HFJTB3 | SAM.gov / USAspending recipient |
| CAGE code | (not pulled) | SAM.gov |
| Federal award total (trailing 5 FYs) | $1,391,367 | USAspending S1 |
| Federal award count | 1 | USAspending S1 |
| Place(s) of performance | CO | USAspending |
| Awarding agencies sampled | (none) | USAspending |
| Class-1 keyword tier | **core** | hits: ASL |
| Website | https://www.vancro.com (Live) | SAM.gov entityURL + curl health-check |
...
### 1. Executive Summary
VANCRO is a core Class-1 Applied Development roll-up add-on candidate, surfaced via U.S. government open data (USAspending federal-award discovery on NAICS 541930 / PSC R608). The company has **$1,391,367** in federal contracts (trailing 5 FYs, 1 awards) with awarding agencies including multiple federal customers. The keyword strategy from `config/offmarket_sources.md` matched on: ASL. The company is **not for sale** — outreach must be proprietary-approach, not broker-mediated.

### 2. Industry & Geography Gate
NAICS 541930 (Translation and Interpretation Services — includes sign-language services per 2022 NAICS definition) is a recognized Applied Development add-on target industry. Place of performance: CO. Physical headquarters: , WA. Not a B1 priority state, but no exclusion.
...
No disclosed P&L; gov-contract revenue is a **size signal**, not an audited financial. Federal awards totaling $1,391,367 over the trailing 5 FYs suggest a small-to-mid market firm by federal-contracting volume, but commercial revenue and non-federal sources are unknown.

### 5. Operations & Team
Insufficient data from public gov sources — fill in via post-outreach diligence. SAM.gov POC: (not disclosed in public tier). Website: https://www.vancro.com (Live).
...
- USAspending recipient profile: `https://www.usaspending.gov/recipient/23b307a1-db11-efe5-fff5-dae3506632ed-C/latest`
- USAspending award search (NAICS 541930 + PSC R608, FY22–26)

- Website health-check (curl): 200 https://vancro.com/
