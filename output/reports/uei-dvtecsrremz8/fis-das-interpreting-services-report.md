# FIS-DAS INTERPRETING SERVICES — Prospect Evaluation
...
| 3 | 10+ years in business | ⚠️ | SAM registered 2019-05-20 (~7 yrs) |
...
| # | Field | Value | Source |
|---|-------|-------|--------|
| 1 | Business Name | FIS-DAS INTERPRETING SERVICES | SAM.gov / USAspending recipient profile |
| 2 | Lead Source | Off-Market — gov data (USAspending + SAM.gov) | S1 / S2 adapters |
| 3 | Years in business | 7 | SAM registration 2019-05-20 |
...
| 9 | Business address | 204 VOLNEY HL, SHENANDOAH JUNCTION, WV, 25442 | SAM.gov physical address |
...
| Signal | Value | Source |
|---|---|---|
| UEI | DVTECSRREMZ8 | SAM.gov / USAspending recipient |
| CAGE code | 8BNK9 | SAM.gov |
| Federal award total (trailing 5 FYs) | $33,099,492 | USAspending S1 |
| Federal award count | 11 | USAspending S1 |
| Place(s) of performance | DC, MD, WV | USAspending |
| Awarding agencies sampled | (none) | USAspending |
| Class-1 keyword tier | **core** | hits: AMERICAN SIGN LANGUAGE, DEAF, SIGN LANGUAGE |
| Website | http://www.fis-das.com (Live) | SAM.gov entityURL + curl health-check |
...
| 3 | Years in business (≥10=10, else 0) | **0** | SAM registered 2019-05-20 (~7 yrs) |
...
### 1. Executive Summary
FIS-DAS INTERPRETING SERVICES is a core Class-1 Applied Development roll-up add-on candidate, surfaced via U.S. government open data (USAspending federal-award discovery on NAICS 541930 / PSC R608). The company has **$33,099,492** in federal contracts (trailing 5 FYs, 11 awards) with awarding agencies including multiple federal customers. The keyword strategy from `config/offmarket_sources.md` matched on: AMERICAN SIGN LANGUAGE, DEAF, SIGN LANGUAGE. The company is **not for sale** — outreach must be proprietary-approach, not broker-mediated.
...
Six standard checks above. Five of six are ⚠️ "insufficient data" — the expected state for an off-market target with no published P&L. Years-in-business is the only header line that can be answered from public data (7 years if SAM registration is a fair proxy). **Verdict: CONDITIONAL (add-on)** — Applied Development add-ons have no size floor, and the gov-data evidence is strong enough to warrant proprietary outreach.

### 4. Financial Snapshot
No disclosed P&L; gov-contract revenue is a **size signal**, not an audited financial. Federal awards totaling $33,099,492 over the trailing 5 FYs suggest a mid-market firm by federal-contracting volume, but commercial revenue and non-federal sources are unknown.

### 5. Operations & Team
Insufficient data from public gov sources — fill in via post-outreach diligence. SAM.gov POC: Alice Ann Friends. Website: http://www.fis-das.com (Live).
...
- USAspending recipient profile: `https://www.usaspending.gov/recipient/8f12f55c-624d-ecf7-7165-2f952e2ad87f-C/latest`
- USAspending award search (NAICS 541930 + PSC R608, FY22–26)
- SAM.gov entity record: api.sam.gov/entity-information/v3/entities?ueiSAM=DVTECSRREMZ8
- Website health-check (curl): 200 https://www.fis-das.com/
