# GREAT HILL SOLUTIONS, LLC — Prospect Evaluation
...
| # | Field | Value | Source |
|---|-------|-------|--------|
| 1 | Business Name | GREAT HILL SOLUTIONS, LLC | SAM.gov / USAspending recipient profile |
...
| Signal | Value | Source |
|---|---|---|
| UEI | D3DYHNPJ6W14 | SAM.gov / USAspending recipient |
| CAGE code | (not pulled) | SAM.gov |
| Federal award total (trailing 5 FYs) | $11,491,870 | USAspending S1 |
| Federal award count | 2 | USAspending S1 |
| Place(s) of performance | MD | USAspending |
| Awarding agencies sampled | (none) | USAspending |
| Class-1 keyword tier | **core** | hits: ASL |
| Website | https://senecanationgroup.com/companies/great-hill-solutions/ (Live) | SAM.gov entityURL + curl health-check |
...
### 1. Executive Summary
GREAT HILL SOLUTIONS, LLC is a core Class-1 Applied Development roll-up add-on candidate, surfaced via U.S. government open data (USAspending federal-award discovery on NAICS 541930 / PSC R608). The company has **$11,491,870** in federal contracts (trailing 5 FYs, 2 awards) with awarding agencies including multiple federal customers. The keyword strategy from `config/offmarket_sources.md` matched on: ASL. The company is **not for sale** — outreach must be proprietary-approach, not broker-mediated.
...
No disclosed P&L; gov-contract revenue is a **size signal**, not an audited financial. Federal awards totaling $11,491,870 over the trailing 5 FYs suggest a mid-market firm by federal-contracting volume, but commercial revenue and non-federal sources are unknown.

### 5. Operations & Team
Insufficient data from public gov sources — fill in via post-outreach diligence. SAM.gov POC: (not disclosed in public tier). Website: https://senecanationgroup.com/companies/great-hill-solutions/ (Live).
...
- USAspending recipient profile: `https://www.usaspending.gov/recipient/f7747802-731c-0690-b7a1-8774bfbfae9b-C/latest`
- USAspending award search (NAICS 541930 + PSC R608, FY22–26)

- Website health-check (curl): 200 https://senecanationgroup.com/companies/great-hill-solutions/
