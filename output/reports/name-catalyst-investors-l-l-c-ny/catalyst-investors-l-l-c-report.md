# Catalyst Investors, L.L.C. — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Catalyst Investors, L.L.C. | SBA SBIC Directory ("Managed by") |
| Location (city, state) | New York, NY | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $140,000,000 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Brian Rich — brian@catalyst.com — 212-863-4848 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Catalyst Investors VI SBIC, L.P.** — vintage 2026, size $140,000,000, avg inv $0, strategy: Growth Equity, style: Growth Equity, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $140,000,000 of committed capital, a typical mgmt-fee yield is in the rough range of **$2,100,000–$3,500,000 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Catalyst Investors, L.L.C." and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Brian Rich.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: brian@catalyst.com.
