# Main Street Capital Corporation — SBIC Prospect Evaluation
...
| 3 | 10+ years in business | ✅ | earliest fund vintage 2002 (~24 yrs of SBIC history) |
...
| Field | Value | Source |
|---|---|---|
| Management entity | Main Street Capital Corporation | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Houston, TX | SBA SBIC Directory |
| # licensed funds under this GP | 2 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $495,833,334 | SBA SBIC Directory |
| Earliest fund vintage | 2002 | SBA SBIC Directory |
| Latest fund vintage | 2016 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Kate Silva — ksilva@mainstcapital.com — (713) 350-6039 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Main Street Capital III, L.P.** — vintage 2016, size $262,500,000, avg inv $3,704,596, strategy: Multiple, style: Hybrid, making new investments: No
- **Main Street Mezzanine Fund, L.P.** — vintage 2002, size $233,333,334, avg inv $1,910,338, strategy: Mezzanine, style: Hybrid, making new investments: No
...
| 3 | Years in business | **10** | earliest fund vintage 2002 (~24 yrs of SBIC history) |
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $495,833,334 of committed capital, a typical mgmt-fee yield is in the rough range of **$7,437,500–$12,395,833 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.

### 4. Investment Strategy & Activity
Strategies on file: Mezzanine, Multiple. Fund styles: Hybrid. Active for new investments: **No (winding down)** — a wind-down GP may indicate willingness to monetize the management entity, including the SBIC license.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Main Street Capital Corporation" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Kate Silva.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: ksilva@mainstcapital.com.
