# New North Ventures — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | New North Ventures | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Portsmouth, NH | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $17,399,821 | SBA SBIC Directory |
...
| Fund styles | (none) | SBA SBIC Directory |
| Investor Relations contact (primary) | Jeremy Hitchcock — jeremy@newnorthventures.com — 603-391-4494 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **New North Ventures Fund II SBIC, LP** — vintage 2025, size $17,399,821, avg inv $0, strategy: Venture, style: ?, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $17,399,821 of committed capital, a typical mgmt-fee yield is in the rough range of **$260,997–$434,995 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.

### 4. Investment Strategy & Activity
Strategies on file: Venture. Fund styles: (none specified). Active for new investments: **Yes** — an active GP suggests an ongoing economic engine.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "New North Ventures" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Jeremy Hitchcock.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: jeremy@newnorthventures.com.
