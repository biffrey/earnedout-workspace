# TCS INTERPRETING, INC. — Prospect Evaluation
...
| 3 | 10+ years in business | ✅ | SAM registered 2002-01-14 (~24 yrs) |
...
| # | Field | Value | Source |
|---|-------|-------|--------|
| 1 | Business Name | TCS INTERPRETING, INC. | SAM.gov / USAspending recipient profile |
| 2 | Lead Source | Off-Market — gov data (USAspending + SAM.gov) | S1 / S2 adapters |
| 3 | Years in business | 24 | SAM registration 2002-01-14 |
...
| 9 | Business address | 8701 GEORGIA AVE STE 510, SILVER SPRING, MD, 20910 | SAM.gov physical address |
...
| Signal | Value | Source |
|---|---|---|
| UEI | MQ42VNNUK3J9 | SAM.gov / USAspending recipient |
| CAGE code | 1FPR1 | SAM.gov |
| Federal award total (trailing 5 FYs) | $34,767,311 | USAspending S1 |
| Federal award count | 12 | USAspending S1 |
| Place(s) of performance | DC, MD | USAspending |
| Awarding agencies sampled | (none) | USAspending |
| Class-1 keyword tier | **core** | hits: AMERICAN SIGN LANGUAGE, ASL, CART, COMMUNICATION ACCESS, DEAF, HARD OF HEARING, VIDEO REMOTE INTERPRETING, VRI |
| Website | https://www.tcsinterpretingandcaptions.com/ (Live) | SAM.gov entityURL + curl health-check |
| Business POC (from SAM.gov public tier) | TCS Contracts | SAM.gov pointsOfContact.governmentBusinessPOC |
...
| 3 | Years in business (≥10=10, else 0) | **10** | SAM registered 2002-01-14 (~24 yrs) |
...
### 1. Executive Summary
TCS INTERPRETING, INC. is a core Class-1 Applied Development roll-up add-on candidate, surfaced via U.S. government open data (USAspending federal-award discovery on NAICS 541930 / PSC R608). The company has **$34,767,311** in federal contracts (trailing 5 FYs, 12 awards) with awarding agencies including multiple federal customers. The keyword strategy from `config/offmarket_sources.md` matched on: AMERICAN SIGN LANGUAGE, ASL, CART, COMMUNICATION ACCESS, DEAF, HARD OF HEARING, VIDEO REMOTE INTERPRETING, VRI. The company is **not for sale** — outreach must be proprietary-approach, not broker-mediated.

### 2. Industry & Geography Gate
NAICS 541930 (Translation and Interpretation Services — includes sign-language services per 2022 NAICS definition) is a recognized Applied Development add-on target industry. Place of performance: DC, MD. Physical headquarters: SILVER SPRING, MD. Priority geography (DC/VA/MD/PA/WV — B1 Phase 1)

### 3. Buy Box (off-market context)
Six standard checks above. Five of six are ⚠️ "insufficient data" — the expected state for an off-market target with no published P&L. Years-in-business is the only header line that can be answered from public data (24 years if SAM registration is a fair proxy). **Verdict: CONDITIONAL (add-on)** — Applied Development add-ons have no size floor, and the gov-data evidence is strong enough to warrant proprietary outreach.

### 4. Financial Snapshot
No disclosed P&L; gov-contract revenue is a **size signal**, not an audited financial. Federal awards totaling $34,767,311 over the trailing 5 FYs suggest a mid-market firm by federal-contracting volume, but commercial revenue and non-federal sources are unknown.

### 5. Operations & Team
Insufficient data from public gov sources — fill in via post-outreach diligence. SAM.gov POC: TCS Contracts. Website: https://www.tcsinterpretingandcaptions.com/ (Live).
...
- USAspending recipient profile: `https://www.usaspending.gov/recipient/81ba951a-b70e-7794-cbbc-d6477bc9b084-C/latest`
- USAspending award search (NAICS 541930 + PSC R608, FY22–26)
- SAM.gov entity record: api.sam.gov/entity-information/v3/entities?ueiSAM=MQ42VNNUK3J9
- Website health-check (curl): 200 https://www.tcsinterpretingandcaptions.com/
