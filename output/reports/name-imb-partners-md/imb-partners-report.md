# IMB Partners — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | IMB Partners | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Bethesda, MD | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $95,002,050 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Tarrus Richardson — trichardson@imbpartners.com — 240-507-1660 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **IMB Partners SBIC I, L.P.** — vintage 2024, size $95,002,050, avg inv $3,090,000, strategy: Hybrid Debt/Equity, style: Hybrid, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $95,002,050 of committed capital, a typical mgmt-fee yield is in the rough range of **$1,425,030–$2,375,051 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "IMB Partners" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Tarrus Richardson.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: trichardson@imbpartners.com.
