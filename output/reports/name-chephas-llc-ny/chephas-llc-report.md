# Chephas, LLC — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Chephas, LLC | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Pittsford, NY | SBA SBIC Directory |
| # licensed funds under this GP | 1 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $24,850,000 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Clint W. Campbell — ccampbell@cephascapital.com — (585) 383-1610 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Cephas Capital Partners III, LP** — vintage 2020, size $24,850,000, avg inv $2,388,429, strategy: Mezzanine, style: Private Credit, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $24,850,000 of committed capital, a typical mgmt-fee yield is in the rough range of **$372,750–$621,250 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Chephas, LLC" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Clint W. Campbell.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: ccampbell@cephascapital.com.
