# CVF Capital Partners — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | CVF Capital Partners | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Davis, CA | SBA SBIC Directory |
| # licensed funds under this GP | 2 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $175,551,000 | SBA SBIC Directory |
...
| Investor Relations contact (primary) | Edward F. McNulty — emcnulty@cvfcapitalpartners.com — 530-757-7004 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Central Valley Fund III (SBIC), L.P.** — vintage 2017, size $111,800,500, avg inv $1,008,711, strategy: Mezzanine, style: Hybrid, making new investments: No
- **The Central Valley Fund III (SBIC), L.P.** — vintage 2017, size $63,750,500, avg inv $0, strategy: Mezzanine, style: Private Equity, making new investments: Yes
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $175,551,000 of committed capital, a typical mgmt-fee yield is in the rough range of **$2,633,265–$4,388,775 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "CVF Capital Partners" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Edward F. McNulty.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: emcnulty@cvfcapitalpartners.com.
