# Dos Rios Partners — SBIC Prospect Evaluation
...
| Field | Value | Source |
|---|---|---|
| Management entity | Dos Rios Partners | SBA SBIC Directory ("Managed by") |
| Location (city, state) | Dallas, TX | SBA SBIC Directory |
| # licensed funds under this GP | 2 | SBA SBIC Directory |
| Total committed capital (sum of fund sizes) | $125,198,002 | SBA SBIC Directory |
| Earliest fund vintage | 2013 | SBA SBIC Directory |
| Latest fund vintage | 2013 | SBA SBIC Directory |
| Any fund making new investments? | No | SBA SBIC Directory |
| Investment strategies | Balanced Venture | SBA SBIC Directory |
| Fund styles | Private Credit | SBA SBIC Directory |
| Investor Relations contact (primary) | Kevin Benoit — kevin@dosriospartners.com — (512) 298-1280 | SBA SBIC Directory |

### Licensed funds (full directory data)
- **Dos Rios Partners, L.P.** — vintage 2013, size $62,679,026, avg inv $894,953, strategy: Balanced Venture, style: Private Credit, making new investments: No
- **Dos Rios Partners-A, L.P.** — vintage 2013, size $62,518,976, avg inv $894,953, strategy: Balanced Venture, style: Private Credit, making new investments: No
...
Not publicly disclosed. Mgmt-fee revenue (typically 2.0–2.5% of committed capital during investment period, stepping down post-investment-period) and carried interest are the GP's two revenue streams. With $125,198,002 of committed capital, a typical mgmt-fee yield is in the rough range of **$1,877,970–$3,129,950 / year** during active fund life — this is a **rough size signal**, not a disclosed figure.

### 4. Investment Strategy & Activity
Strategies on file: Balanced Venture. Fund styles: Private Credit. Active for new investments: **No (winding down)** — a wind-down GP may indicate willingness to monetize the management entity, including the SBIC license.
...
1. **S5 good-standing cross-check** (operator follow-up) — search SBA enforcement actions, OIG reports, and Federal Register SBIC license actions for "Dos Rios Partners" and any of its licensed fund names.
2. **Establish a direct line** — IR contact on file: Kevin Benoit.
3. **Proprietary outreach Template OM-2** — discreet, principal-to-principal approach focused on the management-entity / license-transfer opportunity. Email: kevin@dosriospartners.com.
